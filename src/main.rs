...
fn main()
{
	...
	cam.translate(glm::vec3(0.0, 0.0, -3.0));
	...
	while Window::isOpen()
	{
		...
		{
			cam.fly(glm::vec3(0.0, 0.0, 5.0 * Window::getDeltaTime()));
		}
		...
		{
			cam.fly(glm::vec3(-5.0 * Window::getDeltaTime(), 0.0, 0.0));
		}
		...
		{
			cam.fly(glm::vec3(0.0, 5.0 * Window::getDeltaTime(), 0.0));
		}
		...
		{
			cam.rotate(glm::vec2(0.0, -90.0 * Window::getDeltaTime()));
		}
		...
		{
			cam.rotate(glm::vec2(-90.0 * Window::getDeltaTime(), 0.0));
		}
